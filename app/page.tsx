    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8">
        <div className="animate-fadeIn">
          <h1 className="text-7xl md:text-9xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent animate-gradient mb-4">
            aptheparker
          </h1>
        ...
        <div
          className="flex flex-wrap justify-center gap-6 animate-fadeIn"
          style={{ animationDelay: '0.2s' }}
        >
          <a
            href="/about"
            className="group relative px-8 py-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/50"
          >
            <span className="text-white text-lg font-semibold">About Me</span>
          </a>
          <a
            href="/experience"
            className="group relative px-8 py-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50"
          >
            <span className="text-white text-lg font-semibold">Experience</span>
          </a>
          <a
            href="/dev"
            className="group relative px-8 py-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/50"
          >
            <span className="text-white text-lg font-semibold">Dev Skills</span>
          </a>
          <a
            href="/contact"
            className="group relative px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/50"
          >
